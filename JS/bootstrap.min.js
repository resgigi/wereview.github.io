    ...
    var s = function() {
        ...
        d = function() {
            var t = "modal",
                ...
                c = { DIALOG: ".modal-dialog", DATA_TOGGLE: '[data-toggle="modal"]', DATA_DISMISS: '[data-dismiss="modal"]', FIXED_CONTENT: ".fixed-top, .fixed-bottom, .is-fixed, .-top", _CONTENT: ".-top", NAVBAR_TOGGLER: ".navbar-toggler" },
                u = function() {
                    ...
                    return u.toggle = function(t) { return this._isShown ? this.hide() : this.show(t) }, u.show = function(t) {
                        ...
                        if (this._isBodyOverflowing) {
                            ...
                            }), e(c._CONTENT).each(function(n, i) {
